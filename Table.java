...
public class Table extends JPanel{
	...
	/**
	 * pauses the paintComponent for a moment (to make it visible to human eye)
	 * @param ms: milliseconds paused
	 */
	...
	/**
	 * Sets the initial positions for each word
	 */
	...
	/**
	 * Sorts the list using the bubble sort method (and allows paintComponent to show it visually)
	 */
	...
	/**
	 * Sorts the list using the selection sort method (and allows paintComponent to show it visually)
	 */
	...
	/**
	 * Sorts the list using the insertion sort method (and allows paintComponent to show it visually)
	 */
	public void insertionSort() {
		...
		for(int i = 1; i<pieces.length; i++) {
			...
			layoutPieces();
			int targetX = temp.getX();
			int targetY = temp.getY();;
			/*
	...
	/**
	 * swaps the two pieces at indices i & j
	 * @param i: an index
	 * @param j: another index (can be the same)
	 */
	...
	/**
	 * shifts word down to slide another in
	 * @param p: Piece being shifted
	 * @param lineHeight: How far the piece will be shifted down
	 */
	...
	/**
	 * Animates the piece being lifted up
	 * @param p: Piece being lifted
	 */
	...
	/**
	 * Animates the piece being dropped in a specific place
	 * @param p: the Piece being moved
	 * @param targetY: the y-coordinate where the Piece will be placed 
	 * @param targetX: the x-coordinate where the Piece will be placed
	 */
	...
	/**
	 * Brings each Piece to where it needs to be on the screen based on it's position in the array
	 */
